...
local dist_callback= function(d1, d2, d3, d4, d5, d6)
  ...
  if d[1]>d[2] and d[1]>d[3] and d[1]>d[4] and d[1]>d[5] and d[1]>d[6] then
    -- goto S1
    xdot = 20
    ydot = 25
  elseif d[2]>d[3] and d[2]>d[4] and d[2]>d[5] and d[2]>d[6] then
    -- goto S2
    xdot = 25
    ydot = 15
  elseif d[3]>d[4] and d[3]>d[5] and d[3]>d[6] then
    -- goto S3
    xdot = 20
    ydot = -25
  elseif d[4]>d[5] and d[4]>d[6] then
    -- goto S4
    xdot = -25
    ydot = -15
  elseif d[5]>d[6] then
