...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 main_ahsm.lua   ahsm       debugger                       nil                   the debug output system, like ahsm's "debug_plain"                                                                                                       
                 ...
                 ahsm       timestep                       10                    time in ms between sweeps to check for timed out transitions.                                                                                             
                 ahsm       stacksize                       nil                   ram asigned to ahsm thread in bytes. Defaults to nil, meaning use firmware default (typically 8096).                                                                                             
